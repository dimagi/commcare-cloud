...
# 98. Rolling Upgrade of CouchDB Nodes
...
2. Commit the updated file:
   ...
   ```sh
   git add environments/<env>/public.yml
   git commit -m "Update CouchDB version to 3.4.3"
  ```

 3. If you are using a remote repository, you can push the committed changes:
