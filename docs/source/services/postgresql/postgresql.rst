...
.. toctree::
   ...
   /services/postgresql/add-standby-node.rst
   /services/postgresql/split-partitioned-database.rst
...
See `CommCare HQ docs <https://commcare-hq.readthedocs.io/databases.html>`_ for more detailed information
