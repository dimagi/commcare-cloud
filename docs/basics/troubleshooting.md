...
Often this is because it is unable
using a backing service (such as PostgreSQL, CouchDB, or Redis).
This in term can fall into a number of categories of issue:
...
### Further diagnosis
You can start by backing up and simply checking which of the application services are reporting as up
by running
