...
alias ap='ansible-playbook -u ansible -i ../../commcare-hq-deploy/fab/inventory/$ENV -e "@vars/$ENV/${ENV}_private.yml" -e "@vars/$ENV/${ENV}_public.yml" --vault-password-file="~/.vault_pass_${ENV}.txt" --ask-sudo-pass'
