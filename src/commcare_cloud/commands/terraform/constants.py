...
^/a/([\w\.:-]+)/cloudcare/api/readable_questions/$|^/a/([\w\.:-]+)/cloudcare/apps/report_formplayer_error|^/a/([\w\.:-]+)/data_dictionary/import$|^/a/([\w\.:-]+)/fixtures/edit_lookup_tables/upload/$
^/a/([\w\.:-]+)/fixtures/fixapi/|^/a/([\w\.:-]+)/importer/excel/bulk_upload_api/$|^/a/([\w\.:-]+)/importer/excel/config/$|^/a/([\w\.:-]+)/receiver/$|^/a/([\w\.:-]+)/receiver/([\w-]+)/$
