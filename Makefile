...
autogen = src/commcare_cloud/help_cache/ansible.txt src/commcare_cloud/help_cache/ansible-playbook.txt docs/commcare-cloud/commands/index.md docs/changelog/index.md src/commcare_cloud/terraform/modules/commcarehq/postgresql.autogen.tf $(CHANGELOG_MD)
all : $(autogen)
...
src/commcare_cloud/terraform/modules/commcarehq/postgresql.autogen.tf: src/commcare_cloud/terraform/modules/commcarehq/postgresql.tf.j2
	jinja2 src/commcare_cloud/terraform/modules/commcarehq/postgresql.tf.j2 > src/commcare_cloud/terraform/modules/commcarehq/postgresql.autogen.tf
