...
class Tmux(_Ssh):
    ...
    def run(self, args, ssh_args):
        ...
        if args.remote_command:
            ssh_args = [
                '-t',
                r'sudo -u {cchq_user} tmux attach \; new-window -n {window_name} {remote_command} '
                r'|| sudo -u {cchq_user} tmux new -n {window_name} {remote_command}'
                .format(
                    cchq_user=cchq_user,
            ...
            ssh_args = [
                '-t',
                'sudo -u {cchq_user} tmux attach || sudo -u {cchq_user} tmux new -n {window_name}'
